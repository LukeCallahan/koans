...
class AboutBlocks < Neo::Koan
  ...
  # When I saw curly braces or 'do' and 'end' I know there is a block there. 
  #A block, like almost everything else in ruby, is an object that can be made, deleted, modified.------------------------------------------------------------------
